...
export default function SectionHeader({
    ...
    return (
        ...
        <div className="flex flex-col items-center text-center justify-center md:pt-[73px] md:mb-12 mt-[70px] md:mt-0">
            ...
            <h2 className={`${poppins.className} text-black md:font-[700] font-[600] md:text-[44px] text-[20px] leading-[normal] md:mb-[16px] mb-[10px]`}>
                {title}
            </h2>

            {/* Description - Using Poppins 400 and the 15px/16px sizing from the grid items */}
            <div className={`${poppins.className} font-[400] md:text-[16px] text-[14px] leading-[19.8px] text-black max-w-[600px] px-4`}>
                {description}
            </div>
        </div>
    );
