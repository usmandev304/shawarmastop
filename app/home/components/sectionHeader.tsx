...
export default function SectionHeader({
    ...
    return (
        <div className="flex flex-col items-center text-center justify-center md:pt-[73px] md:mb-12 lg:mb-3 mb-7 mt-[50px] md:mt-12 lg:mt-15">
            ...
            <h2 className={`${poppins.className} text-black md:font-[700] lg:font-[600] font-[600] md:text-[44px] text-[20px] leading-[normal] lg:mb-[19px] md:mb-[16px] mb-[10px]`}>
                {title}
            </h2>
