                    ...
                    <div className="flex w-full min-w-0 flex-col gap-8 lg:max-w-[55%]">
                        <div className="flex w-full flex-col gap-4 text-white">
                            ...
                            <div className="capitalize leading-tight ">
                                <p className="mb-0 text-[clamp(2rem,8vw,5rem)] font-[600] leading-[1.1] lg:text-[4vw] md:text-[5vw] lg:leading-[90px] md:leading-[60px]">{`Savour the `}</p>
                                <p className={`${poppins.className} mb-0 text-[clamp(2rem,8vw,5rem)] font-[600] leading-[1.1] lg:text-[4vw] md:text-[5vw] lg:leading-[90px] md:leading-[60px]`}>Shawarma Stop</p>
                                <p className="text-[clamp(2rem,8vw,5rem)] font-[600] leading-[1.1] lg:text-[4vw] md:text-[5vw] lg:leading-[90px] md:leading-[60px]">Difference</p>
                            </div>
                            <p className="max-w-xl lg:text-[16px] md:text-[17px] text-[15px] leading-[26px] md:leading-[28px]">
