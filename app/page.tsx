        ...
        <div>
          <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
            <div className="sm:mb-[100px] mb-[50px] lg:mb-[120px] md:mb-[30px]">
              <h1 className={`${poppins.className} text-white text-center lg:text-[5.7vw] md:text-[44px] sm:text-[60px] text-[32px] font-[700] mb-[15px] lg:mb-[10px] md:mb-[10px] leading-[1.1]`}>
                The Best <br /> Shawarma Bite
              </h1>
              <p className={`${poppins.className} text-white text-center lg:text-[20px] md:text-[18px] md:font-[400] sm:text-[20px] text-[14px] font-[500] max-w-[418px] lg:max-w-[668px] md:max-w-[520px] sm:max-w-[520px] mb-[30px] sm:mb-[40px]`}>
                Gather your friends and family and enjoy the best Shawarma in town. Freshly made and delivered hot!
              </p>
              <div className="flex justify-center">
                <Link href="/order">
                  <button className="bg-[#FDED8B] text-[#F95233] sm:text-[20px] text-[14px] font-[500] lg:px-15 px-5 sm:py-3.5 py-2 cursor-pointer rounded-full">
                    View Our Menu
                  </button>
                </Link>
              </div>
