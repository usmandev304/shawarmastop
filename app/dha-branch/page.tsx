...
import dhabrach from '../../images/lakecity/dhaBrach.png';
...
export default function DhaBranchPage() {
  ...
  return (
    <>
      <Image src={dhabrach} alt="Pia Branch" className="h-full w-full object-contain" priority />
